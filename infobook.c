...
void namefun(){
	...
	double phone;
	char gender[8];
	fptr=fopen("phone.txt","ab+");//ab+ gives us the ability of writing the function and add the second data in the existing one...
	if(fptr==NULL){
...
void exitfun(){
	...
	gotoxy(31,6);
	printf("\xDB YAZHINI M");
	gotoxy(31,8);
	
}
void password(void){
	char passwords[20]={"yazhini"};
	gotoxy(22,2);
	int j;
	int z;
